...
let questions = [
    ...
    {
    numb: 2,
    question: "What is the worst case time complexity of linear search algorithm?SS stand for?",
    answer: "Ο(n2)",
    options: [
      "Ο(1)",
      "Ο(n)",
    ...
    {
    numb: 5,
    question: "The worst case complexity of binary search matches with − ",
    answer: "Linear search",
    options: [
      "Interpolation search",
      "Linear search",
